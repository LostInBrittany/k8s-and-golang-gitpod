ARG GITPOD_IMAGE=gitpod/workspace-go:latest
FROM ${GITPOD_IMAGE}

## Update the packet cache
RUN sudo apt update

## Installing Operator Framework SDK
RUN curl -LO https://github.com/operator-framework/operator-sdk/releases/download/v1.25.0/operator-sdk_linux_amd64 && \
